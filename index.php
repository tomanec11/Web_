...
<div class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
        <p class="lead mb-4">Nabízíme ubytování ve vile Taťána, která se nachází na pěší zóně v samém centru lázní Luhačovice. Poblíž je supermarket a mnoho dalších obchodů. K dispozici je také parkování.</p>
    </div>
</div>

<div class="bg-opacity-75 bg-primary ">
    <div class="container">

        <div class="row py-5">
            <div class="col-md-7">
                <h2 class="featurette-heading">Ubytování</h2>
                <p class="lead">Poskytujeme v sedmi dvoulůžkových pokojích a jednom jednolůžkovém. K dispozici je i přistýlka</p>
            </div>
            <div class="col-md-5">
        ...
        <div class="row py-5">
            ...
            <div class="col-md-7">
                ...
                <p class="lead">Všechny pokoje jsou vybaveny varnou konvicí, televizí a k dispozici je taktéž lednice. Pokoje bez vlastního sociálního zařízení jsou vybaveny umyvadlem.</p>
            </div>
        </div>
        ...
        <div class="row py-5">
            <div class="col-md-7">
                ...
                <p class="lead">Máme také WI-FI zdarma. Heslo je na každém pokoji.</p>
            </div>
            <div class="col-md-5">
...
<div class="container pt-5">
    ...
    <div class="row text-center text-lg-start">
        ...
        <div class="col-lg-3 col-md-4 col-6">
            <a href="image/IMG_4786.JPG" data-toggle="lightbox" data-gallery="gallery" class="d-block mb-4 h-100">
                <img class="img-fluid img-thumbnail" src="image/IMG_4786.JPG" alt="">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6">
